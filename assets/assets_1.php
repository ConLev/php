...
/*
	...
	Переменная в PHP должна состоять из латинских символов (хотя язык допускает имя переменной на других языках) и цифр,
    не должна содержать спецсимволов, кроме "_", и не может начинаться с числа
...
/*
	...
	но согласно стандартам, константы пишутся заглавными буквами
*/
...
/*
	...
	* NULL - просто "ничего". Использование этого значения применимо в случаях, когда нужно указать,
...
/*
	...
	* двоичные : 0b[01]
	...
	Все числа ниже равны 42 в 10-тичной системе
*/
